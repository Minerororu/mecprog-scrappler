...
const scraperObject = {
  ...
  scrapeRelatorio: async (browser, equipamento, equipamentoIndex) => {
    ...
    if (horarioTotal - equipamento?.valorUltimoApontamento != 0) {
      ...
      axios.post('https://mecprog-firebase-email.herokuapp.com', {colecao: 'apontamentos', obj: apontamentoObj})
        .catch(err => console.log(err.message))
      equipamento.valorUltimoApontamento = horarioTotal;
      axios.post('https://mecprog-firebase-email.herokuapp.com', {colecao:'equipamentos', obj: equipamento})
        .catch(err => console.log(err.message))
    };
    browser.close()
  },
